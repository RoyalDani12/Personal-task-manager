  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-950 text-white font-sans">
      ...
      <div className="flex flex-1 relative">
        ...
        <aside className="fixed top-[64px] left-0 h-[calc(100vh-64px)] w-64 z-[60] bg-[#0E0F13] border-r border-slate-800/60 overflow-y-auto">
          <Sidebar UserName={user.name} avatar={user.avatar} />
        </aside>

        {/* MAIN CONTENT - Pushed right by pl-64 */}
